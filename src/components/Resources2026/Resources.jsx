      ...
      <div className="resources-title">
          ...
          <div className="Section resources-text">
            <h5>
              ...
              important resources you need for the exploretech.la 2026 event! If you can't find what 
          ...
          <div className='Section full-length-button'>
            ...
            <Button
              ...
              href={"https://drive.google.com/file/d/1QBPh_9WEnlVxcw18xKHrCtPD4Wv9tfrj/view?usp=sharing"}
              target="_blank"
