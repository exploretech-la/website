            ...
            <div className="About">
                <div className="about-container">
                    ...
                    <div className="about-content">
                        ...
                        <p>Through our panels, interactive workshops, exhibitor booths, and partnerships with industry and academic organizations, we introduce students to the larger applications tech outside the classroom.</p>
                    </div>
                </div>
