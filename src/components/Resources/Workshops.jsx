        ...
        <CardDeck className="card-row">
          <Card className="text-center">
            ...
            <ListGroup className="list-group-flush">
              <ListGroupItem>
                <Card.Link href="https://youtu.be/-NN-O42OleY">
                  Session 2 Recording
                </Card.Link>
              </ListGroupItem>
              <ListGroupItem>
                <Card.Link href="https://docs.google.com/document/d/1ElU9F8cRtpw7QWjIj3QkJsBVG8xmE2Ywpd2b8Gxi75w/edit">
                  Student Guide
                </Card.Link>
              </ListGroupItem>
              <ListGroupItem>
                <Card.Link href="https://docs.google.com/presentation/d/1sZ5aDpGpKbjd5CuhOd5hTCljncScBwf3m7FWMb6_jd4/edit#slide=id.gbbd58c2398_0_15">
                  Slides
                </Card.Link>
              </ListGroupItem>
              <ListGroupItem>
                <Card.Link href="https://docs.google.com/document/d/1UDakvA2lzu5px7Ox20s7E8ZYN17WtcPTcmtoTANRL5o/edit">
                  Solutions
                </Card.Link>
              </ListGroupItem>
            </ListGroup>
          ...
          <Card className="text-center">
            <Card.Body>
              <Card.Title>
                <b>ExploreWeb.la: Web Design & Dev</b>
              </Card.Title>
              <YoutubeEmbed embedId="jP8itIcFFa4" />
            </Card.Body>
            <ListGroup className="list-group-flush">
              <ListGroupItem>
                <Card.Link href="https://docs.google.com/presentation/u/0/d/1QB4seIW1s97Aqrf-Wn8n9UQq6YNM3opvqzt3ZUZtGOM/edit">
                  Slides
                </Card.Link>
              </ListGroupItem>
              <ListGroupItem>
