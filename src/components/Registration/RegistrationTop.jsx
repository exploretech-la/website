          ...
          <div className="registration-content registration-event-info">
            <div className="left-column text">
              ...
              <div className="registration-description">
                <p>
                  ...
                  communities in the Greater Los Angeles Area to explore
                ...
                <ul className="no-style">
                  <li>
                    <b>Event Dates:</b> April 10-11, 2021
                  </li>
                  <li>
            ...
            <div className="right-column text">
              ...
              <div className="registration-types">
                ...
                <p>
                  <b>Deadline:</b> January 24, 2021 at 11:59PM PST
                </p>
                <p>
                  <em>
                    *As long as space permits and all eligibility requirements
                    are met, you will be accepted and guaranteed a box.
                  </em>
                </p>
                <div className="section-title">
                  <h4 className="title">
                ...
                <p>
                  <b>Deadline:</b> February 28, 2021 at 11:59PM PST
                </p>
                <p>
                  <b>NOTE:</b> Keep an eye out for a confirmation email from us
                  by early March if you are a general registration applicant!
                </p>
                <div className="section-title">
                  <h4 className="title">
                    Late Registration -{" "}
                    <Badge variant="warning">By Email Only</Badge>
                  </h4>
                </div>
                <p>
                  <em>
                    *If you are still interested in attending our event, please
                    email us at exploretechla@cs.ucla.edu
                  </em>
                </p>
              </div>
            </div>
