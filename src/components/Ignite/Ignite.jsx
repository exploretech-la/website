          ...
          <div className="content-wrapper">
            ...
            <div className="workshop-cards-container">
              <div className="workshop-card">
                ...
                <p className="card-description">
                  Dive into one of the most versatile and widely used
                  programming languages. This track will teach you essential
                  Python concepts and guide you through practical projects,
